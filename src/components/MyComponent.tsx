...
const Desktop = ({ className }: Props) => {
  return (
    ...
    >
      ...
      <div className="ml-[46px] w-64 h-[77px] mt-[35px] text-[64px] font-inter font-normal text-black tracking-[0] leading-[normal]">
        タイトル
      </div>

      <div className="ml-36 w-[1151px] h-24 mt-[67px] text-[40px] font-inter font-normal text-black tracking-[0] leading-[normal]">
